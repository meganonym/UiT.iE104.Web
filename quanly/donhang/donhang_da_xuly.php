...
$tongso_record = mysqli_num_rows(lay_danhsach_donhang_done_t($ketnoi));//tính tổng số bản ghi
...
$danhsach_donhang_done = lay_danhsach_donhang_done_s($ketnoi,$batdau, $gioihan);

// lấy View
require 'donhang_da_xuly_v.php';
