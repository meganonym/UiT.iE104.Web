...
//$danhsach_nguoidung = lay_danhsach_nguoidung($ketnoi);
...
$tongso_record = mysqli_num_rows(lay_danhsach_nguoidung_t($ketnoi));//tính tổng số bản ghi
...
$danhsach_nguoidung = lay_danhsach_nguoidung_s($ketnoi,$batdau, $gioihan);


// lấy View
require 'nguoidung_danhsach_v.php';
